          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {featuredProjects.map((project, index) => {
              ...
              return (
                ...
                >
                  <Card className="border-0 shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col h-full">
                    <CardHeader className="pb-3">
                      <motion.div 
                        className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary to-accent flex items-center justify-center mb-3"
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {otherProjects.map((project, index) => (
                <motion.a 
                  ...
                  className="bg-background rounded-lg p-4 group block"
